                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('create') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <input id="password" type="text" class="form-control @error('day') is-invalid @enderror" name="day" required autocomplete="day">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('year') is-invalid @enderror" name="month" required autocomplete="month">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('gender') is-invalid @enderror" name="sex" required autocomplete="sex">
